...
|--------|------|---------|------|
| 無料 | ¥0 | 月30回 | 基本機能すべて |
| プレミアム | ¥500/月 | 月300回 | + 優先サポート |
| 学生スポンサー | ¥3,000/月 | 無制限 | + 学生10名を無料招待 |
...
│ 解説生成           │ gpt-4o   │ ~$0.04     │
│ 画像解説           │ gpt-4o   │ ~$0.04     │
│ セクション分析     │ gpt-4o-mini │ ~$0.001  │
└────────────────────┴──────────┴────────────┘

【スケール別月額コスト】
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
100ユーザー（各月30回利用）:
  3,000呼び出し × $0.03平均 = ~$90/月

1,000ユーザー（各月30回利用）:
  30,000呼び出し × $0.03平均 = ~$900/月

  ※ gpt-4o-miniに切り替えた場合: ~$90/月
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
【1,000ユーザー時の予想】
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Firestore: $1-5/月（無料枠内〜少し超過）
Storage: $5-10/月（PDF保存が増える場合）
Functions: $10-20/月（API Proxy用）
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
合計: ~$20-35/月
```
...
```
【Phase 1: クローズドベータ（100人）】
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
OpenAI API:  ~$50-100/月
Firebase:    ~$0-10/月（無料枠内）
ドメイン:    ~$15/年
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
合計: ~$50-110/月
...
│     └─ 複数の問題を1回のAPI呼び出しで処理                  │
│                                                             │
│  4. ユーザー自身のAPIキー使用オプション                     │
│     └─ パワーユーザー向けに自分のキーを使える機能          │
│                                                             │
└─────────────────────────────────────────────────────────────┘
```
